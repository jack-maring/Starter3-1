      ...
      while (requesting) {
        ...
        switch(choice) {
          ...
          case 3:
            ...
            break;
          case 4:
            System.out.println("Choose charCount, enter string to count chars for:");
            String count = scanner.nextLine();

            System.out.println("If you would like to count a specific char then enter it, otherwise enter 0:");
            String targetChar = scanner.nextLine();

            json.put("type", "charcount");
            json.put("count", count);
            
            if (targetChar.equals("0")) {
              json.put("findchar", false);
            } else {
              json.put("findchar", true);
              json.put("find", targetChar);
            }
        ...
        if (res.getBoolean("ok")){
          if (res.getString("type").equals("echo")) {
            ...
            System.out.println(res.getString("inventory"));
          } else {
